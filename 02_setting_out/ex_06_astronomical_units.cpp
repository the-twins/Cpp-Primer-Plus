...
const double AstronomicalUnitsInLightYear = 63240;

double astronomical_units(double light_year);
...
int main()
{
    ...
    cin >> light_year;
    cout << light_year << " light years = " << astronomical_units(light_year) << " astronomical units." << endl;
...
double astronomical_units(double light_year)
{
    return light_year * AstronomicalUnitsInLightYear;
}
